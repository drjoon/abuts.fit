...
BEGIN_OPERATION; 316; CONNECTION; 0;
   ...
   Text; 513; ;  CAPTION; 문자; SOURCE; 2; TECHCODETYPE; 3;
	BEGIN_STRING; 513;;
		...
		:G99 G1 X6.0 F0.1
		:G1 X3.412 F0.015
		:G1 X2.84 Z[#520+1.472](#1+1.447) F0.015
		:G1Z[#520+2.362](#1+2.377) F0.01
		:G2 X2.689 Z[#520+2.459] R0.1 F0.008
		:G1 X2.444 Z[#520+2.491] F0.008
		:G1 X2.229 Z[#520+3.043] F0.008
