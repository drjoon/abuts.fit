...
BEGIN_OPERATION; 316; CONNECTION; 0;
   4437; 4437; 0;  SOURCE; 1; TECHCODETYPE; 2;
   4420; 4420; 2017;  SOURCE; 1; TECHCODETYPE; 2;
   ...
   4907; 4907; ;  SOURCE; 1; TECHCODETYPE; 3;
	BEGIN_STRING; 4907;;
		:
	END_STRING
   ...
   4904; 4904; ;  SOURCE; 1; TECHCODETYPE; 3;
	BEGIN_STRING; 4904;;
		:
	END_STRING
   4003; 4003; 61;  SOURCE; 1; TECHCODETYPE; 1;
   ...
   4425; 4425; 42;  SOURCE; 1; TECHCODETYPE; 2;
   ...
   4422; 4422; 14;  SOURCE; 1; TECHCODETYPE; 2;
   ...
   4436; 4436; 9;  SOURCE; 1; TECHCODETYPE; 1;
   ...
   4909; 4909; ;  SOURCE; 1; TECHCODETYPE; 3;
	BEGIN_STRING; 4909;;
		:
	END_STRING
   ...
   4906; 4906; ;  SOURCE; 1; TECHCODETYPE; 3;
	BEGIN_STRING; 4906;;
		:
	END_STRING
   ...
   4903; 4903; ;  SOURCE; 1; TECHCODETYPE; 3;
	BEGIN_STRING; 4903;;
		:
	END_STRING
   ...
   Comment; 7; ;  CAPTION; 주석; SOURCE; 1; TECHCODETYPE; 3;
	BEGIN_STRING; 7;;
		:
	END_STRING
   4424; 4424; 57;  SOURCE; 1; TECHCODETYPE; 2;
   ...
   4438; 4438; 0;  SOURCE; 1; TECHCODETYPE; 2;
   4421; 4421; 3;  SOURCE; 1; TECHCODETYPE; 2;
   ...
   4908; 4908; ;  SOURCE; 1; TECHCODETYPE; 3;
	BEGIN_STRING; 4908;;
		:
	END_STRING
   ...
   4905; 4905; ;  SOURCE; 1; TECHCODETYPE; 3;
	BEGIN_STRING; 4905;;
		:
	END_STRING
   ...
   4902; 4902; ;  SOURCE; 1; TECHCODETYPE; 3;
	BEGIN_STRING; 4902;;
		:
	END_STRING
   ...
   4423; 4423; 16;  SOURCE; 1; TECHCODETYPE; 2;
   Text; 513; ;  CAPTION; 문자; SOURCE; 2; TECHCODETYPE; 3;
	BEGIN_STRING; 513;;
		: 
		: 
		:N100 T0303 (T0303OD BACK NR0.05)
		:(BACKTURNING)  (OSSTEM M)
		:G97 M13  S2500
		:G0 Z[#520]
		:X18.
		:G99 G1 X6.0 F0.1
		:G1 X2.861 F.01
		:X2.35 Z[#520+1.315] F.01
		:Z[#520+3.5] F.01
		:X16.0 F0.1
		:G0 X40.0
		:G0 Z-5.0
		...
		:X16.0
                :G99 G1 X6.0 F0.1
		:G1 X2.861 F.015
		:G1 X2.35 Z[#520+1.315] F.015
		:Z[#520+2.55] F.01
		:X2.342 Z[#520+2.593] F.008
		:X2.32 Z[#520+2.636] F.008
		:X2.283 Z[#520+2.675] F.008
		:X2.233 Z[#520+2.711] F.008
		:X2.171 Z[#520+2.742] F.008
		:X2.1 Z[#520+2.767] F.008
		:X2.021 Z[#520+2.785] F.008
		:X1.937 Z[#520+2.796] F.008
		:X1.85 Z[#520+2.8] F.008
		:X16.0 F0.1
		:G0 X40.0
		:G0 Z-5.0
		:G0 T0
