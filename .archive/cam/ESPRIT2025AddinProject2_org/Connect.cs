...

    {
...

        {
...

            {
                ...
                _espApp.OutputWindow.Text(banner);
...

            {
                ...
                System.Diagnostics.Trace.WriteLine(banner);
...

            {
...

                {
                    ...
                    using (var toast = new AddInToastForm(banner))
...

        {
            ...
            _heartbeatTimer = new System.Threading.Timer(_ => SafeHeartbeat(), null, HeartbeatInterval, HeartbeatInterval);
...

        {
...

            {
...

                {
                    ...
                    _espApp.OutputWindow.Text("My Dental Addin");
...

            {
                ...
                System.Diagnostics.Trace.WriteLine($"Connect: heartbeat failed - {ex.Message}");
