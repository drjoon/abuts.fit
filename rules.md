...
⚠️ **주의**: DNS 전파 후에도 "Domain is not found or is inactive" 에러가 발생할 수 있습니다. 이 경우:

- DNS 전파 완료 후 몇 시간 대기 (Brevo 서버에서 DNS 인식 시간 필요)
- Brevo 지원팀 문의: https://app.brevo.com → Help & Support
