...
- 주문 마감: **자정(24:00 KST)까지 접수분은 당일 16:00 집하**, 이후 접수분은 다음 영업일 16:00 집하
...
- 운영 기준 시각은 **오후 2시 라벨 출력, 오후 4시 집하(code 11)** 입니다. `printed`는 출력 완료, `accepted`는 접수 완료, `picked_up`는 집하 완료, `completed`는 최종 배송 완료를 의미합니다. **자정(24:00 KST)까지 접수분은 같은 날 집하(16:00), 이후 접수분은 다음 영업일 집하** 기준으로 작업을 계획합니다.
