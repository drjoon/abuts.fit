              ...
              <label className="flex justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    value={maxWaitDays}
                    onChange={(e) =>
                      setMaxWaitDays(Number(e.target.value) || 1)
                    }
                    className="w-15 px-3 py-2 text-base border border-slate-300 rounded-lg bg-white shadow-sm focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                  />
                  <span className="text-base font-medium text-blue-900">
                    일
                  </span>
