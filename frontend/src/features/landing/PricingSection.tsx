...
import { PartnershipBenefitsModal } from "@/components/PartnerShipBenefitsModal";
            ...
            <div className="flex flex-col items-center h-full">
              <Card className="w-full h-full shadow-elegant min-h-[480px] flex flex-col border-2 border-primary/30">
                ...
                <CardContent className="flex-1 flex flex-col justify-center space-y-4">
                  ...
                  <button
                    className="mt-2 w-full flex items-center justify센터 gap-2 bg-blue-100 hover:bg-blue-200 text-blue-800 font-semibold py-2 px-4 rounded-md transition-colors duration-200"
