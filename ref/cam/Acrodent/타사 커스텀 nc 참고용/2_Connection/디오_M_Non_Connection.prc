...
BEGIN_OPERATION; 316; CONNECTION; 0;
   ...
   OriginalKey; 4003; 13;  SOURCE; 0; TECHCODETYPE; 1;
   ...
   Text; 513; ;  CAPTION; 문자; SOURCE; 2; TECHCODETYPE; 3;
	BEGIN_STRING; 513;;
		...
		:(BACKTURNING)  (DIO MINI)
		:G97 M13  S2500
                :G0 Z[#520]
		:X18.
		:G99 G1 X6.0 F0.1
		:G1 X2.382 F0.01
		:G1 X1.669 Z[#520+1.835] F0.01
		:G2 G18 X1.512 Z[#520+1.9] R0.08 F0.008
		:G1 Z[#520+2.1] F0.008
		:G1 X16.0 F0.1
		:G0 X40.0
		:G0 Z-5.0
