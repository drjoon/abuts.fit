...
- 리퍼럴 코드 랜덤, 추천인: **고정 배정** (간접 수수료 검증 가능하도록)
  - r001~r003: s001 직접 소개 (s001 직접 수수료 5%)
  - r004~r005: s004 직접 소개 (s004 직접 수수료 5% + s001 간접 수수료 2.5%)
  - r006~r007: s006 직접 소개 (s006 직접 수수료 5%)
  - r008~r010: s009 직접 소개 (s009 직접 수수료 5%)
- 입금: 50만/100만/200만/300만원 4종 중 랜덤으로 `CreditLedger` CHARGE 생성
- 보너스: 조직당 30,000원 `CreditLedger` BONUS 생성 (무료 크레딧, 의뢰에서만 사용)
- 의뢰 기록: **최근 20일 내 20~100건 랜덤 생성**, 금액 정책:
