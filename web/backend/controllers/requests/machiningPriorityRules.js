  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        "Next Up 카드를 다른 장비로 드래그 이동할 수 있다(가공중/완료 제외). 대상 소재≥maxDiameter 필수",
        "드래그 이동 시 기존 NC를 삭제하고 Esprit를 다시 돌려 해당 장비 소재 직경에 맞는 NC를 생성한다",
        "NC 재생성 중에는 Next Up에 「CAM 재생성 중」 오버레이를 표시한다",
