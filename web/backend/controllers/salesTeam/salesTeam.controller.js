  ...
  try {
    ...
    return res.json({
      ...
      data: {
        referralCode,
        policyNote:
          "판매·세금계산서는 플랫폼 가입 사업자만 가능합니다. 커스텀어벗은 런칭 이벤트 1만원·정상가 1.3만원(배송비, 기공소는 FM덴탈 월정액 배송 선택 가능). 기공소 플랫폼 사용료는 정책 2%이며 지금은 이벤트 기간으로 무료(0%)입니다. 하청 수행만 매출의 10%가 공제됩니다. 소개코드로 가입한 거래처가 담당 실적으로 집계됩니다. 의뢰자가 90일간 주문(커스텀 어벗 의뢰)이 없으면 소개 귀속이 리셋되어, 누구든 다시 영업할 수 있습니다.",
