  ...
  try {
    ...
    return res.json({
      ...
      data: {
        referralCode,
        policyNote:
          "판매·세금계산서는 플랫폼 가입 사업자만 가능합니다. 커스텀어벗은 런칭 이벤트 1만원·정상가 1.3만원(배송비, 기공소는 FM덴탈 월정액 배송 선택 가능). 협력건은 수수료 없이 기공비 전액을 크레딧으로 적립합니다. 하청건은 10% 영업 수수료를 제한 나머지를 적립합니다. 소개코드로 가입한 거래처가 담당 실적으로 집계됩니다. 90일 무주문이면 소개가 리셋됩니다.",
