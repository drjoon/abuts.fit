              ...
              <CardContent>
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <div>
                    ...
                    <p>
                      본 사업자 정보는 관련 법령에 따라 공시되며, 정보통신망
                      이용촉진 및 정보보호 등에 관한 법률에 따라
                      통신판매업신고를 완료하였습니다.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      소비자분쟁해결기준(공정거래위원회 고시)에 따라 피해를
                      보상받을 수 있습니다. 분쟁 조정 신청은
                      소비자분쟁조정위원회(www.ccn.go.kr) 또는
                      개인정보보호위원회(www.privacy.go.kr)에 신청할 수
                      있습니다.
                    </p>
                  </div>
                </div>
