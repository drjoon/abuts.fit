// change-log:
// - 2026-08-09: 디자인+가공 출고 +1영업일 안내를 SHIP_OUT_INFO_MESSAGE에 반영.
...
const SHIP_OUT_INFO_MESSAGE =
  "출고일은 리드타임 기준으로 계산됩니다. 묶음출고는 자정까지 접수시 다음 날 오후 4시 출고, 신속출고는 정오까지 접수시 당일 오후 4시 출고됩니다. 디자인+가공은 묶음·신속 모두 +1영업일입니다.";
