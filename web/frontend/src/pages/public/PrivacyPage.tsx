                  ...
                  {section === 1 && (
                    <>
                      ...
                      <ul className="list-disc list-inside space-y-1 ml-4">
                        ...
                        <li>
                          서비스 개선을 위한 식별자를 뺀 집계·품질 지표
                        </li>
                        <li>
                          기공회원이 학습 이용에 동의한 경우, 환자 성명·차트·연락처를
                          분리하고 가명처리한 작업 완료 3D 모델과 스캔 형상만 학습
                          <br />
                          거부한 건은 학습에 넣지 않으며, 재식별하지 않습니다
                        </li>
                        <li>법정 의무 이행</li>
                      </ul>
                    </>
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <ul className="list-disc list-inside space-y-1 ml-4">
                            ...
                            <li>마케팅 수신 동의 정보</li>
                            <li>
                              학습 이용에 동의한 기공 의뢰의 가명처리된 작업 완료
                              3D 모델과 스캔 형상
                              <br />
                              환자 성명·차트·연락처는 분리하며 재식별하지 않습니다
                            </li>
                          </ul>
                        </div>
                      </div>
