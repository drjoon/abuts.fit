// change-log:
// - 2026-09-26: 제9조④·제13조 플랫폼 사용료·영업 수수료 안내를 정책 문장에 맞춤.
// - 2026-09-21: 제6조 — 딜러·영업 소개 귀속 90일 무주문 리셋 안내.
// - 2026-09-20: 제3편=표준 하청·위탁 가공 계약. 제4·9·13조에 동일조건·개별협상 배제·단가 공시.
    ...
    <PublicPageLayout>
      <div className="space-y-8 max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
            ...
            <CardContent>
              <div className="space-y-4 text-slate-600">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>
                    "기공회원"이란 기공물을 회사에 공급하는 치과기공소(어벗츠기공소
                    포함)를 의미합니다. 기공회원은 회사에 대한 공급사입니다.
                  </li>
                  <li>
                    "제조회원"이란 커스텀 어벗먼트 등 제조를 회사에 하청 공급하는
          ...
          <Card className={PUBLIC_CARD_CLASS}>
            ...
            <CardContent>
              <div className="space-y-4 text-slate-600">
                ...
                <p>
                  3. 기공회원으로 가입·등록하는 경우, 제1항의 약관 동의에는
                  제3편(표준 하청·위탁 가공 계약)에 대한 동의가 포함되며, 별도
                  서면 계약 없이도 회사와의 표준 하청 계약이 성립한 것으로
                  봅니다.
                </p>
              </div>
            </CardContent>
            ...
            <CardContent>
              <div className="space-y-4 text-slate-600">
                ...
                <p>
                  ...
                  청구됩니다. 회사는 겸영사업자로서 기공·커스텀어벗·크레딧
                  경로에는 부가가치세(VAT)를 부과하지 않고, 스토어 기성품 및
                  제조사·딜러사·개발운영사 지급에는 관계 법령에 따라
                  부가가치세를 적용합니다.
                </p>
                <p>
                  3. 기공물의 제작은 회사가 지정한 기공회원 또는 제조회원이
                  담당합니다. 커스텀 어벗먼트의 가공은 현재 애크로덴트(제조회원)가
                  수행합니다.
                </p>
                <p>
                  4. 딜러사·영업본부 소개로 가입한 의뢰자가
                  <br />
                  90일 무주문이면 소개가 리셋됩니다. 상세는 서비스 화면의
                  딜러십·영업 정책 안내를 따릅니다.
                </p>
              </div>
            </CardContent>
          ...
          <Card className={PUBLIC_CARD_CLASS}>
            <CardHeader>
              <CardTitle>제7조 (크레딧·거래 선수금 및 환불)</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4 text-slate-600">
                <p>
                  1. 회사는 플랫폼 내 계약 물품·용역 대금 결제를 위해
                  크레딧을 제공합니다. 크레딧은 선불전자지급수단(선불페이)이
                  아니라 B2B 거래 선수금(예치금)이며 서비스 화면에서는
                  크레딧으로 표시합니다. 입금(충전) 시점에는 (세금)계산서를
                  발행하지 않으며, 사용분 기준으로 매월 말 면세(기공·어벗)와
                  과세(스토어)를 각각 합산 발행합니다.
                </p>
                <p>
          ...
          <div className="pt-4">
            ...
            <h2 className="mt-1 text-2xl font-semibold text-[#0b2a5c]">
              기공회원의 기공물 공급(표준 하청·위탁 가공 계약)
            </h2>
          </div>

          <Card className={PUBLIC_CARD_CLASS}>
            <CardHeader>
              <CardTitle>제9조 (거래 관계·표준 하청 계약)</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4 text-slate-600">
                <p>
                  1. 본 편은 기공회원이 회사에 기공물을 공급하고 대금을 정산받는
                  과정에서의 권리와 의무를 규정하며, 기공회원 가입·약관 동의와
                  동시에 회사와 기공회원 사이의 표준 하청(위탁 가공·매입)
                  계약으로 성립합니다. 제10조부터 제14조까지(제작·납기·하자·
                  정산·직거래 금지 등)는 본 표준 계약의 일부입니다.
                </p>
                <p>
                  2. 회사와 기공회원의 거래는 [치과회원 → 회사(매출)] 및 [회사
                  → 기공회원(매입)]의 도소매 유통 및 위탁 가공 관계로
                  성립합니다. 회사는 원청으로서 치과회원에 대한 의뢰 접수·수가·
                  공급 책임을 지고, 기공회원은 하청 수행·공급사로서 회사에
                  기공물을 공급합니다. 기공회원과 치과회원 사이에는 본 서비스
                  이용과 관련하여 직접적인 매매 계약이 성립하지 않습니다.
                </p>
                <p>
                  3. 본 편의 단가(수가)·수수료·하자 책임·납기·정산 주기 등
                  상업 조건은 모든 기공회원에게 동일하게 적용합니다. 회사와
                  개별 기공회원 사이에 위 조건에 관한 개별 협상·특약은 원칙적으로
                  하지 않으며, 변경은 제3조에 따른 약관 개정 또는 서비스 화면의
                  일괄 공지로만 합니다.
                </p>
                <p>
                  4. 매입·정산의 기준 금액은 서비스에 표시된 원청 수가(기공비
                  등)와 서비스 화면에 공시한 하청 영업 수수료에 따릅니다.
                  <br />
                  협력 의뢰는 기공비 전액을 적립하고, 하청 의뢰는 영업 수수료를
                  차감한 나머지를 적립합니다.
                  <br />
                  구체 요율·적용 시점은 서비스 화면 공시에 따릅니다.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className={PUBLIC_CARD_CLASS}>
            <CardHeader>
              <CardTitle>제13조 (대금 정산 및 증빙)</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4 text-slate-600">
                <p>
                  1. 회사는 매월 1일부터 말일(KST)까지 서비스에서 정산 대상으로
                  확정된 거래 내역을 기준으로 정산하고, 익월 1일에 기공회원·제조회원에게
                  정산 대금을 지급합니다. 지급일이 금융기관 휴무일인 경우 다음
                  영업일에 지급할 수 있습니다.
                </p>
                <p>
                  2. 정산 금액은 해당 거래의 치과회원 결제액에서 계약 또는
                  서비스 화면에 정한 하청 영업 수수료(정률 또는 정액)를 뺀
                  금액으로 하며, 제9조 제3항·제4항에 따라
                  개별 단가 협상이 아닌 공시 기준을 적용합니다. 제11조 및
                  제12조에 따른 공제·상계가 있는 경우 이를 반영합니다.
                  제조회원·딜러사·개발운영사 과세 정산은 부가세 포함가 잔액을
                  그대로 지급하며, 세금계산서는 포함가를 공급가와 부가세로
                  분해합니다.
                </p>
                <p>
                  3. 치과·기공소·어벗츠 사이 기공·커스텀어벗·크레딧 경로는
                  부가가치세 면세 대상에 해당합니다. 스토어 기성품 및
                  제조사·딜러사·개발운영사에 대한 지급은 과세 대상입니다.
                </p>
                <p>
                  4. 기공회원은 정산 금액 확정 즉시 회사를 공급받는 자로 하여
                  법정 계산서(면세용)를 발행하여야 합니다. 제조회원은 세금계산서를
                  발행하여야 합니다. 회사는 관계 법령이 허용하는 범위에서 위수탁
                  발행할 수 있습니다. 증빙 미발행 또는 오발행 시 회사는 대금
                  지급을 보류할 수 있습니다.
                </p>
                <p>
                  5. 정산 대금은 기공회원·제조회원이 서비스에 등록한 계좌로
                  지급합니다.
                </p>
                <p>
                ...
                <p>
                  7. 협력 의뢰는 기공비 전액을 크레딧으로 적립합니다.
                  <br />
                  하청 의뢰는 서비스 화면에 공시한 영업 수수료(기본 10%)를
                  차감한 나머지를 크레딧으로 적립합니다.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className={PUBLIC_CARD_CLASS}>
            ...
            <CardContent>
              <div className="space-y-4 text-slate-600">
                ...
                <p>
                  3. 회사는 보철 제작·정산·상담에 필요한 의뢰 내역을 이용합니다.
                  <br />
                  서비스 개선은 이름·차트번호·연락처를 뺀 집계와 품질 지표로
                  합니다.
                  <br />
                  AI 학습은 환자 성명·차트·연락처를 분리한 작업 완료 3D 모델과
                  스캔 형상만 가명처리한 뒤 사용하며, 재식별하지 않습니다.
                  <br />
                  기공회원이 학습 이용을 거부한 건은 학습에 넣지 않습니다.
                </p>
                <p>
                  4. 제2항을 위반한 경우 회사는 이용계약을 즉시 해지하고, 발생한
