            ...
            <CardContent>
              <div className="space-y-4 text-slate-600">
                ...
                <p>
                  ...
                  등)와 서비스 화면에 공시한 플랫폼 사용료·영업 수수료에
                  따릅니다.
                  <br />
                  협력 의뢰는 플랫폼 사용료를 차감하고, 하청 의뢰는 플랫폼
                  사용료와 영업 수수료를 함께 차감합니다.
                  <br />
                  작업 결과를 AI 학습에 이용하도록 동의한 경우 플랫폼 사용료는
                  면제합니다.
                  <br />
            ...
            <CardContent>
              <div className="space-y-4 text-slate-600">
                ...
                <p>
                  ...
                  서비스 화면에 정한 플랫폼 사용료·영업 수수료(정률
                  또는 정액)를 뺀 금액으로 하며, 제9조 제3항·제4항에 따라
                ...
                <p>
                  7. 기공소의 플랫폼 사용료는 서비스 화면에 공시한 요율(기본
                  2%)이며, 매출액에서 공제합니다.
                  <br />
                  협력 의뢰와 하청 의뢰 모두 플랫폼 사용료를 차감한 뒤 크레딧으로
                  적립합니다.
                  <br />
                  협력 의뢰에는 별도의 영업 수수료가 없으며, 하청 의뢰에는 공시한
                  영업 수수료(기본 10%)가 추가됩니다.
                  <br />
                  기공회원이 작업 결과를 AI 학습에 이용할 수 있도록 동의하면
                  플랫폼 사용료는 면제됩니다.
                  <br />
