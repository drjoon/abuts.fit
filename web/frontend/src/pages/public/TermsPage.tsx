          ...
          <div className="space-y-8">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    1. 회사는 서비스 이용료 결제를 위해 <b>크레딧</b>(서비스
                    내부에서만 사용 가능한 선결제 잔액)를 제공합니다.
                  </p>
                  <p>
                    2. 크레딧은 서비스 이용료/제작비 정산에 한하여 사용되며,
                    회원 간<b> 양도</b> 또는 현금 <b>출금</b>은 불가합니다.
                  </p>
                  <p>
                    3. 크레딧에는 별도의 소진기간(사용기한)을 두지 않습니다.
                  </p>
                  <p>
                    4. 크레딧 환불은 <b>계정 해지</b> 시점에 한하여 진행되며,
                    계정 해지 이전에는 환불을 신청할 수 없습니다.
                  </p>
                  <p>
                    5. 환불 금액은 <b>잔여 유료 크레딧(공급가)</b> 기준으로
                    산정되며, 무료/이벤트로 지급된 크레딧(보너스 크레딧)은 환불
                    대상에서 제외됩니다.
                  </p>
                  <p>
                    6. 결제 시 포함된 <b>부가가치세(VAT)</b>는 잔여 공급가
                    비율에 따라 비례 환불됩니다.
                  </p>
                  <p>
                    7. 가상계좌 등 결제수단의 특성에 따라 환불을 위해
                    은행/계좌번호/ 예금주 등 환불계좌 정보가 필요할 수 있으며,
                    회사 확인 후 환불 계좌로 입금하는 방식으로 처리될 수
                    있습니다.
                  </p>
                </div>
              </CardContent>
