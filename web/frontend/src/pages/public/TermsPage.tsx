    ...
    <PublicPageLayout>
      <div className="space-y-8 max-w-4xl mx-auto">
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-600">최종 개정일: 2026년 9월 20일</p>
        </div>
          ...
          <Card className={PUBLIC_CARD_CLASS}>
            ...
            <CardContent>
              <div className="space-y-4 text-slate-600">
                ...
                <p>
                  4. 딜러사·영업본부 소개로 가입한 의뢰자(치과·기공소)가
                  90일간 커스텀 어벗 주문이 없으면 해당 소개 귀속은 해제되며,
                  이후 누구든 다시 영업할 수 있습니다. 상세는 서비스 화면의
                  딜러십·영업 정책 안내를 따릅니다.
                </p>
              </div>
            </CardContent>
            ...
            <CardContent>
              <div className="space-y-4 text-slate-600">
                ...
                <p>
                  ...
                  등)와 서비스 화면에 공시한 하청 수수료율에 따릅니다. 회사가
                  기공회원에게 하청 수행을 배정한 경우, 해당 거래의 기공회원
                  수령액은 원칙적으로 「해당 거래 기공비 × (1 − 공시 하청
                  수수료율)」로 산정하며, 구체 수가·수수료율·적용 시점은
                  서비스 화면 공시에 따릅니다.
                </p>
              </div>
            </CardContent>
            ...
            <CardContent>
              <div className="space-y-4 text-slate-600">
                ...
                <p>
                  ...
                  서비스 화면에 정한 플랫폼 이용 수수료·하청 수수료율(정률
                  또는 정액)을 뺀 금액으로 하며, 제9조 제3항·제4항에 따라
