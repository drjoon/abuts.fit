// change-log:
// - 2026-09-26: 제13조⑦ 플랫폼 사용료·AI 학습 이용 동의·면제·변경 시점.
          ...
          <Card className={PUBLIC_CARD_CLASS}>
            ...
            <CardContent>
              <div className="space-y-4 text-slate-600">
                ...
                <p>
                  7. 지정·협력 기공 의뢰의 플랫폼 사용료는 서비스 화면에 공시한
                  요율(기본 2%)이며, 작업시작 시 기공 매출액에서 공제합니다.
                  <br />
                  하청 수행은 하청 수수료에 같은 플랫폼 사용료를 더합니다.
                  <br />
                  기공회원이 AI 학습 이용에 동의하면, 작업 완료 때 올리는 3D
                  모델을 학습에 사용하고 플랫폼 사용료만 면제합니다.
                  <br />
                  동의하지 않으면 그 사용료를 공제합니다.
                  <br />
                  허용해도 하청 수수료는 그대로입니다.
                  <br />
                  어벗츠기공소는 항상 동의한 것으로 봅니다.
                  <br />
                  동의는 설정에서 변경할 수 있고, 변경은 아직 끝나지 않은 의뢰부터
                  적용합니다.
                  <br />
                  완료·취소된 의뢰에는 소급하지 않습니다.
                  <br />
                  치과회원에게는 이 플랫폼 사용료를 청구하지 않습니다.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className={PUBLIC_CARD_CLASS}>
            ...
            <CardContent>
              <div className="space-y-4 text-slate-600">
                ...
                <p>
                  3. AI 학습 이용은 기공회원의 동의에 따릅니다.
                  <br />
                  동의한 작업 완료 3D 모델만 학습에 사용합니다.
                </p>
                <p>
