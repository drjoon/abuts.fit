// change-log:
// - 2026-08-09: 디자인+가공 출고 +1영업일(묶음·신속) 안내 추가.
// related files:
              ...
              <div className="space-y-4 text-slate-600">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>
                      ...
                      가공만은 STL(의뢰) 1건=1개, 디자인+가공은 한 STL에 여러
                      어벗이 있으면 어벗 수만큼 과금합니다. 디자인+가공은
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <li>
                      디자인+커스텀어벗 의뢰 시 디자인비는 가공비와 별도로
                      추가되며, (가공단가+디자인비)×어벗수가 소비됩니다. 한
