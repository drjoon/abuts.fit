// change-log:
// - 2026-09-26: 플랫폼 사용료·AI 학습 이용 동의·면제 안내.
            ...
            <CardContent>
              <div className="space-y-4 text-slate-600">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>
                      지정·협력 기공 의뢰의 플랫폼 사용료는 작업시작 시 기공
                      매출액의 2%입니다.
                      <br />
                      하청 수행은 하청 수수료에 같은 사용료를 더합니다.
                    </li>
                    <li>
                      AI 학습 이용에 동의하면, 작업 완료 때 올리는 3D 모델을
                      학습에 사용하고 플랫폼 사용료만 면제됩니다.
                      <br />
                      동의하지 않으면 그 사용료가 공제됩니다.
                      <br />
                      하청 수수료는 그대로입니다.
                    </li>
                    <li>
                      ...
                      <br />
                      치과에는 이 플랫폼 사용료가 없습니다.
                    </li>
                    <li>
                      동의는 설정에서 바꿀 수 있고, 바꾸면 아직 끝나지 않은 이번
                      의뢰부터 적용됩니다.
                      <br />
                      완료·취소된 의뢰는 바꾸지 않습니다.
                    </li>
