        ...
        >
          <header className="relative px-4 py-3 flex items-center justify-between border-b border-slate-800 bg-slate-900 text-slate-50">
            <div className="flex items-center gap-4 min-w-0 flex-1">
              ...
              {saveStatus === "saved" && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-primary/10 text-primary-muted border border-primary/40 text-[11px]">
          ...
          {error && (
            <div className="px-4 py-2 text-xs text-destructive bg-destructive-soft border-b border-destructive-muted">
              {error}
            </div>
          )}
        ...
        description={
          <div className="space-y-3 text-sm">
            <input
              ...
              className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm focus:ring-primary focus:border-primary"
              placeholder="네자리 숫자"
            />
          </div>
        }
