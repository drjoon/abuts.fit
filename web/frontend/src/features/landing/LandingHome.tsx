  ...
  return (
    <div className="bg-white text-slate-900">
      ...
      <section className="relative flex min-h-[calc(100svh-3.5rem)] items-end overflow-hidden bg-black sm:min-h-[calc(100svh-4rem)]">
        ...
        <div className={cn(landingContent, "relative z-10 pb-16 pt-28 sm:pb-24")}>
          ...
          <Button
            type="button"
            className="mt-10 h-12 rounded-full bg-white px-7 text-base font-semibold text-slate-900 hover:bg-white/90"
            onClick={goStart}
          >
      ...
      <section id="browse" className="bg-[#f3f4f6] pt-4 pb-8 sm:pt-5 sm:pb-10 lg:pt-6 lg:pb-12">
        ...
        {landingOffers.map((offer) => {
          const frame = cn(
            ...
            TILE_FRAME,
            offer.slug === "platform" && "lg:col-span-3 h-[22rem] sm:h-[28rem] lg:h-[34rem] lg:min-h-0",
          );
          const caption = (
            <>
          ...
          const captionClass =
            "absolute inset-x-0 bottom-0 z-10 bg-gradient-to-t from-black/80 via-black/40 to-transparent px-6 pb-7 pt-24 sm:px-8 sm:pb-8";
