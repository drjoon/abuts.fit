...
// - 2026-08-20: 표기 = 주문→도착 남은 영업일 합계(N영업일).
// - 2026-08-15: 주문-치과도착 + N영업일(카드/필드).
...
import {
  ...
  formatPracticeWorkPeriodTotalLabel,
...
type PracticeWorkPeriodTextProps = {
   ...
   * lead: N영업일(폼 라벨 옆).
   * days: N영업일.
   * labeled: 작업+배송기간 N영업일.
   * orderArrival: 주문-치과도착 · N영업일(목록 카드).
   */
...
export function PracticeWorkPeriodText({
  ...
  const daysLabel = formatPracticeWorkPeriodTotalLabel(days);
