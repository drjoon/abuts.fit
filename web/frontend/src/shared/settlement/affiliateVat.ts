// change-log:
// - 2026-09-20: 익월 초 (세금)계산서 발행 후 지급(말일 일괄 카피 정리).
// - 2026-09-06: 과세 장부=부가세 포함가. 지급 시 재가산 없음(÷1.1 분해·세금계산서).
// - 2026-08-23: 제조사=일반과세. 매입가(부가세 포함) 분해·지급 시 VAT·세금계산서.
// - 2026-08-20: 제조사는 유료·무료 구분 없이 약정 단가 전액. 미정산 적립 후 익월 초 지급.
...
/** 부가세 포함가 → 공급가·세액(제조사 매입가·과세 잔액 SSOT). */
...
/** 과세 정산 화면 공통 안내. 장부=포함가, 지급=잔액 그대로. */
export const SETTLEMENT_VAT_PAYOUT_NOTICE =
  "장부·미정산은 부가세 포함가입니다. 지급 시 재가산 없이 잔액을 입금하며, 세금계산서는 포함가÷1.1로 분해합니다.";
...
export const SETTLEMENT_VAT_POLICY = {
  taxable:
    "제조사·딜러사·개발운영사 장부는 부가세 포함가입니다. 지급은 잔액 그대로이며 세금계산서만 ÷1.1로 분해합니다.",
  exempt:
    "치과·기공소·어벗츠 사이 기공·커스텀어벗·크레딧은 면세입니다. 부가세가 없고 세금계산서가 아닌 계산서를 발행합니다.",
  storeTaxable:
    "스토어 기성품은 과세입니다. 고객 가격·장부는 부가세 포함가이며 세금계산서를 발행합니다. 커스텀어벗·크레딧 계산서와 합치지 않습니다.",
  manufacturerEarn:
    "하청 적립·미정산은 매입가(부가세 포함)입니다. 지급 시 재가산 없이 잔액을 입금하고 세금계산서를 수취합니다. 고객의 유료·무료 크레딧과 무관하게 모든 의뢰·배송에 약정 단가를 지급하며, 월중 미정산으로 쌓인 뒤 익월 초 (세금)계산서 발행 후 입금합니다.",
  salesmanPayout:
    "딜러사 수수료 장부는 부가세 포함가입니다. 지급은 잔액 그대로이며 세금계산서를 ÷1.1로 분해합니다.",
  devopsPayout:
    "개발운영사 잔여 분배 장부는 부가세 포함가입니다. 지급은 잔액 그대로이며 세금계산서를 ÷1.1로 분해합니다.",
  adminExempt:
