...
/** 관계사(제조사·영업자·개발운영사) 지급 부가세율. 루트 rules.md §2.3. */
...
export const SETTLEMENT_VAT_POLICY = {
  taxable:
    "부가세는 어벗츠가 제조사·영업자·개발운영사에게 지급할 때 붙습니다. 지급액에 부가세 10%를 더하고 세금계산서를 수취합니다.",
  exempt:
    "치과·기공소·어벗츠(관리자) 사이는 면세입니다. 부가세가 없고 세금계산서가 아닌 계산서를 발행합니다.",
  manufacturerEarn:
    "하청 적립은 공급가입니다. 부가세 10%는 지급 시 합산하고 세금계산서를 수취합니다. 유료만 지급하며 무료는 확인용(지급 0)입니다.",
  salesmanPayout:
