// change-log:
// - 2026-09-20: 과세 지급 안내 문구 단축(포함가·잔액 그대로·÷1.1).
...
export const SETTLEMENT_VAT_PAYOUT_NOTICE =
  "장부·미정산은 부가세 포함가입니다. 지급은 잔액 그대로 · 세금계산서만 ÷1.1 분해.";
...
export const SETTLEMENT_VAT_POLICY = {
  taxable:
    "제조사·딜러사·개발운영사 장부는 부가세 포함가입니다. 지급은 잔액 그대로 · 세금계산서만 ÷1.1 분해.",
  exempt:
  ...
  salesmanPayout:
    "딜러 수수료는 부가세 포함가입니다. 지급은 잔액 그대로 · 세금계산서만 ÷1.1 분해.",
  devopsPayout:
    "개발운영 잔여 분배는 부가세 포함가입니다. 지급은 잔액 그대로 · 세금계산서만 ÷1.1 분해.",
  adminExempt:
