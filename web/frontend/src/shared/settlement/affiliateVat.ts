...
export const SETTLEMENT_VAT_POLICY = {
  ...
  exempt:
    "치과·기공소·제조사·어벗츠 사이 기공·커스텀어벗·크레딧은 면세입니다. 부가세가 없고 세금계산서가 아닌 계산서를 발행합니다.",
  storeTaxable:
    "스토어 기성품은 과세입니다. 고객 가격은 부가세 포함가이며 세금계산서를 발행합니다. 커스텀어벗·크레딧 계산서와 합치지 않습니다.",
  manufacturerEarn:
    "하청 적립은 공급가입니다. 제조사는 기공소(면세)로 등록되어 부가세 없이 지급합니다. 고객의 유료·무료 크레딧과 무관하게 모든 의뢰·배송에 약정 단가를 지급하며, 매달 말일 일괄 지급 전까지 미정산 잔액으로 쌓입니다.",
  salesmanPayout:
