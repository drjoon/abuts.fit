  ...
  return (
    ...
    >
      ...
      <div className="relative space-y-2">
        <p className="text-[14px] font-medium uppercase tracking-[0.18em] text-white/55">
      ...
      >
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <span
              className={cn(
                "inline-flex rounded-full px-2.5 py-0.5 text-[14px] font-semibold tracking-wide",
                isPractice
          ...
          <h3 className="whitespace-nowrap text-base font-semibold tracking-tight text-slate-900">
            {copy.headline}
          </h3>
...
function ProofStat({
  ...
  return (
    ...
    >
      ...
      <div className="mt-1.5 text-xl font-bold tracking-tight tabular-nums text-slate-900 sm:text-2xl">
        {value}
      </div>
    </div>
  );
