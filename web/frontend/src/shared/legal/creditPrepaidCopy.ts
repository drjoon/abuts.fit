...
// - 2026-09-20: 사용분 월합·익월 초 발행 카피.
// - 2026-08-23: B2B 거래 선수금. 충전 시 계산서 없음 → 사용분 월합 면세/과세 분리 발행.
...
export const CREDIT_LEDGER_PREPAID_NOTICE_BODY =
  "유료 크레딧은 플랫폼 계약 물품·용역용 B2B 거래 선수금입니다. 선불페이가 아니며, 미사용 잔액은 요청 시 환불됩니다. (세금)계산서는 사용분 기준 월합으로 익월 초에 발행합니다.";

/** 내역 탭 — 무료 카드 툴팁. */
export const CREDIT_LEDGER_FREE_NOTICE_BODY =
  "이전에 적립된 무료 크레딧(잔여분)입니다. 기공의뢰·어벗 생산·배송 등에 다른 크레딧보다 먼저 사용되며, 환불 대상이 아닙니다. 신규 자동 무료 크레딧 지급은 없으며, 관리자가 수동으로 지급한 경우에만 적립됩니다.";
...
export const CREDIT_PREPAID_FAQS: CreditPrepaidFaq[] = [
  ...
  },
  {
    ...
    a: "아니요. 입금(충전) 시점에는 발행하지 않습니다. 사용한 금액만 월합으로 면세 계산서(기공·어벗)와 과세 세금계산서(스토어)를 각각 합산해 익월 초에 발행합니다.",
  },
  {
    q: "충전 후 남은 크레딧은 환불이 가능한가요?",
    a: "네, 가능합니다. 거래 계약이 중도 해지되거나 미사용된 선수금 잔액에 대해서는 요청 시 전액 환불해 드립니다. 이미 월합으로 발행된 (세금)계산서가 있으면 필요 시 마이너스 수정으로 처리합니다. 무료·이벤트로 지급된 크레딧은 환불 대상에서 제외됩니다.",
  },
  {
