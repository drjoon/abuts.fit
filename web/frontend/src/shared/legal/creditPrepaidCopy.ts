...
export const CREDIT_CHARGE_NOTICE_BODY =
  "본 충전은 플랫폼 내 기공물 발주를 위한 기공료 선납(선입금)입니다.\n입금 즉시 부가가치세법에 따른 면세 계산서 발행 대상이 되며, 충전된 크레딧은 앱 내 기공물·어벗 주문 대금 및 치과 멤버십 월 구독료(부가세 없음) 결제용으로 사용됩니다.\n기공크레딧(치과 수취·정산) 적립 경로와는 별도로 관리됩니다.";

/** 내역 탭 — 유료 카드「기공료 선입금」툴팁. */
export const CREDIT_LEDGER_PREPAID_NOTICE_BODY =
  "유료 크레딧은 기공물 발주를 위한 기공료 선납(선입금)입니다. 선불페이가 아니며, 앱 내 기공물·어벗 주문 대금과 치과 멤버십 월 구독료(부가세 없음)로 사용됩니다. 미사용 잔액은 요청 시 환불됩니다.";
...
export const CREDIT_PREPAID_FAQS: CreditPrepaidFaq[] = [
  {
    ...
    a: "아닙니다. 어벗츠 크레딧은 치과 보철물 유통 계약에 따른 기공료 선입금(선납 대금)입니다. 금융 유통 마진이나 환전의 개념이 아니며, 기공물 제작·커스텀 어벗먼트 구매 대금과 치과 멤버십 월 구독료(부가세 없음)로 차감 처리가 가능합니다.",
  },
  {
