...
export const CREDIT_PREPAID_FAQS: CreditPrepaidFaq[] = [
  {
    ...
    a: "아닙니다. 어벗츠 크레딧은 치과 보철물 유통 계약에 따른 기공료 선입금(선납 대금)입니다. 금융 유통 마진이나 환전의 개념이 아니며, 기공물 제작·커스텀 어벗먼트 구매 대금으로 차감 처리가 가능합니다.",
  },
  {
