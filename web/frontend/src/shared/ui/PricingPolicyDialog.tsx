          ...
          <DialogDescription asChild>
            <div className="space-y-4 pt-2 text-sm text-muted-foreground">
              ...
              <section className="space-y-1">
                ...
                <p>
                  <b>지난달</b> 완료 주문 건수에 따라 아래와 같이 자동
                  할인됩니다.
                </p>
                <ul className="list-disc pl-4 space-y-0.5">
                  <li>지난달 주문 건당 20원이 할인됩니다.</li>
                  <li>
                    최대 5,000원까지 할인되며, 할인 한도 도달 시 개당
                    10,000원이 됩니다. (250건 이상 시 최저가)
                  </li>
                  <li>
                    예) 지난달 주문 250건 이상 시 커스텀 어벗 단가는
                    10,000원으로 적용됩니다.
                  </li>
                </ul>
              </section>
              ...
              <section className="space-y-1">
                ...
                <ul className="list-disc pl-4 space-y-0.5">
                  <li>
                    본인과 본인이 직접 추천한 기공소(직계 1단계)의 지난달
                    주문량을 합산하여 할인 단가를 계산합니다.
                  </li>
                  <li>
              ...
              <section className="space-y-1">
                ...
                <p>
                  주문량 집계는 <b>매달 1일 자정(KST 00:00)</b>에 업데이트되며,
                  적용 단가는 업데이트 이후 해당 월 전체에 반영됩니다.
                </p>
              </section>
