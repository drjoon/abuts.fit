...
const printPngWindows = ({ filePath, printer, title }) =>
  new Promise((resolve, reject) => {
    ...
    const psScript = [
      ...
      "  $imgW = $bitmap.Width",
      "  $imgH = $bitmap.Height",
      "  # ZPL PW984 x LL787 @ 203dpi = 4.847in x 3.877in (123mm x 98.5mm)",
      "  # Page units = 1/100 inch for PrintDocument",
      "  $destW = [float](984.0 / 203.0 * 100.0)",
      "  $destH = [float](787.0 / 203.0 * 100.0)",
      "  $srcRect = New-Object System.Drawing.Rectangle 0, 0, $imgW, $imgH",
      "  $dstRect = New-Object System.Drawing.RectangleF 0, 0, $destW, $destH",
      "  $e.Graphics.DrawImage($bitmap, $dstRect, $srcRect, [System.Drawing.GraphicsUnit]::Pixel)",
