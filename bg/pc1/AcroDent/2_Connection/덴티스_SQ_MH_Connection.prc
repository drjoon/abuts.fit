...
BEGIN_OPERATION; 316; CONNECTION; 0;
   ...
   4003; 4003; 64;  SOURCE; 0; TECHCODETYPE; 1;
   ...
   4906; 4906; ;  SOURCE; 0; TECHCODETYPE; 3;
	BEGIN_STRING; 4906;;
		:Jeon
	END_STRING
   TurretID; 792; 2;  CAPTION; 터렛 이름; SOURCE; 2; TECHCODETYPE; 1;
   ...
   Comment; 7; ;  CAPTION; 주석; SOURCE; 1; TECHCODETYPE; 3;
	BEGIN_STRING; 7;;
		:
	END_STRING
   4424; 4424; 15;  SOURCE; 0; TECHCODETYPE; 2;
   ...
   4423; 4423; 23;  SOURCE; 0; TECHCODETYPE; 2;
   Text; 513; ;  CAPTION; 문자; SOURCE; 2; TECHCODETYPE; 3;
    ...
    :(Deburr Step drill)
		:M88
		:M3 S3000 T4444 (D1.615*D2.25)
		:G99 G0 X0.0 Z-1.5
		:G4 U0.2
		:G1 Z0.0 F0.1
		:G1 Z2.5 F0.04
		:G83 Z[#520+#523+3.4] Q1000 P5 F0.025
    :G80
		:G0 Z-1.5
    :G0 T0
    :M89
    ...
    :(Connection Rough Turn/NR0.4)
		...
		:
		:(Rough U0.1)
    :M3 S3500 T0404 (B-Turn/NR0.08)
    :G99G0 X[#521+1.8] Z[#520+#523-0.07]
    :G1 X4.0 F0.1
    :G1 X3.7 F0.03
    :G1 X3.092 F0.01
    :G1 X2.421 W1.727
		:G1 X2.475 W0.027
		:G2 X2.61 W0.163 R0.23
		:G1 W0.657
		:G1 X2.158 W0.226
		:G1 W0.5
		:G1 U0.4 F0.03
		...
		:G28H0
		:M23 S5500
		:G0 X[#521+1.0] Y2.0 Z[#520+#523+2.48] C0.0
		:G98 G1X2.085 F3000
		:G1 Y-2.0 F200
		:G0 H60.0
		:G1 Y2.0F200 
    ...
    :M51
		...
		:G28H0
		:M23 S1000
		:G98 G0 X[#521+1.8]Z[#520+#523+1.95]Y0.6C0.0
		:G4 U0.05
    :G1 X4.0 F2000
		:G1 X3.05 F500
		:
    ...
    :(Finish Connection)
    :M3 S3500 T0404(B-Turn/NR0.08)
    :G99 G0 X[#521+1.8]Z[#520+#523-0.12]
    :G1 X4.0 F0.1
    :G1 X3.6 F0.05
    :G1 X3.01 F0.01
    :G4 U0.2
		...
		:G28H0.0
		:M23 S5500
		:G0 X[#521+1.0] Y2.0 Z[#520+#523+2.45] C0.0
		:G98 G1X2.085 F3000
		:G1 Y-2.0F300
		:G0 H60.0
		:G1 Y2.0F300 
		...
		:G28H0
		:M23S2000
		:G98G0X[#521+1.8]Z[#520+#523+1.95]Y0.6C0.0
		:G1X4.0F2000
		:G1X3.05 F500
		:
		:M98P0001
