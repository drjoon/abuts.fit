...
namespace Acrodent.EspritAddIns.ESPRIT2025AddinProject
{
    ...
    public class Connect : DPTechnology.AnnexLibraries.EspritAddIn
    {
        ...
        public Esprit.Document _espDoc;
        ...
        public static int _iCntOfCommands = 2;
        ...
        public void _ConnectionManager_AddInConnect(Esprit.Application espritApplication)
        {
            ...
            {
                _iCNumbs.Add(EC.AddCommand(_MyCookie, i, "TEST Command " + i));
            }

            for (int i = 0; i < _iCntOfCommands; i++)
            {
                Esprit.ToolBarControl tbcon = _newToolbar.Add(EspritConstants.espToolBarControl.espToolBarControlButton, "MKK_button_" + i.ToString(), _iCNumbs[i]);
                tbcon.Enabled = true;
                tbcon.Name = "TEST Command " + i.ToString();
            }
            ...
            _tbMenu.Add(EspritConstants.espMenuItemType.espMenuItemSeparator);
            _tbMenu.Add(EspritConstants.espMenuItemType.espMenuItemCommand, "Command 2", _iCNumbs[1]);
        ...
        private void EC_OnCommand(int Cookie, int UserId)
        {
            ...
            switch (UserId)
            {
                case 0:
                    // command example.
                    MessageBox.Show("You got command #1 !");
                    break;
                case 1:
                    // -------------------------
                    // 4. Add a tab in project manager
                    // -------------------------
