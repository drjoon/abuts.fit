...
[TypeIdentifier]
public interface IFeatureSets : IEnumerable
{
	[DispId(0)]
	FeatureSet this[[In][MarshalAs(UnmanagedType.Struct)] object Index]
	{
	...
	[DispId(1)]
	[return: MarshalAs(UnmanagedType.Interface)]
	FeatureSet Add([Optional][In][MarshalAs(UnmanagedType.Struct)] object FeatureType);
