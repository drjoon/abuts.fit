...
[TypeIdentifier]
public interface IFeatureChains : IEnumerable
{
	[DispId(0)]
	FeatureChain this[[In][MarshalAs(UnmanagedType.Struct)] object Index]
	{
	...
	[DispId(1)]
	[return: MarshalAs(UnmanagedType.Interface)]
	FeatureChain Add([In][MarshalAs(UnmanagedType.Interface)] Point StartingPoint);
