				...
				checked
				{
					...
					default:
					{
						...
						for (int i = 1; i <= count2 && i <= MainModule.Document.Layers.Count; i++)
						{
							...
							if ((Operators.CompareString(layer.Name, "Boundry", false) == 0) | (Operators.CompareString(layer.Name, "TurningLayer", false) == 0) | (Operators.CompareString(layer.Name, "RoughMillingLayer", false) == 0) | (Operators.CompareString(layer.Name, "RotateCenter", false) == 0) | (Operators.CompareString(layer.Name, "GeoTemp", false) == 0) | (Operators.CompareString(layer.Name, "FreeFormLayer", false) == 0) | (Operators.CompareString(layer.Name, "FaceDrill", false) == 0) | (Operators.CompareString(layer.Name, "TurnOperation", false) == 0) | (Operators.CompareString(layer.Name, "TurnOperation_A", false) == 0) | (Operators.CompareString(layer.Name, "TurnOperation_B", false) == 0) | (Operators.CompareString(layer.Name, "RoughMillingOperation", false) == 0) | (Operators.CompareString(layer.Name, "FreeFormMill", false) == 0) | (Operators.CompareString(layer.Name, "EndTurning", false) == 0))
							{
