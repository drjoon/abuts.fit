...
namespace DentalAddin
{
    internal sealed partial class MainModule
    {
        ...
        private static bool TryRunComposite2SplitABCore(FreeFormFeature freeFormFeature)
        {
            ...
            double stlStartX = GetPostMoveTipXMin();
            ...
            // Finish_Back 끝 = BackPointX (구 +0.3mm 연장 제거: #520 밴드/tip 정합 어긋남).
            ...
            // 정책: Finish_Back 종료 기준점은 BackPointX
        ...
        private static bool TryGetSplitABConfig(out double splitX, out string prcA, out string prcB)
        {
            ...
            double xMin = GetPostMoveTipXMin();
