...
BEGIN_OPERATION; 316; CONNECTION; 0;
   ...
   Text; 513; ;  CAPTION; 문자; SOURCE; 2; TECHCODETYPE; 3;
    ...
    :(Deburr Step drill)
		...
		:G1 Z0.0 F0.1
		:G1 Z2.5 F0.04
		:G83 Z[#520+#523+3.2] Q1000 P5 F0.025
    :G80
		:G0 Z-1.5
    :G0 T0
    :M89
    ...
    :M3 S3500 T0404 (B-Turn/NR0.08)
		...
		:G28H0
		:M23 S5500
		:G0 X[#521+1.0] Y2.0 Z[#520+#523+2.25] C0.0
		:G98 G1X2.295 F3000
		:G1 Y-2.0F200
		:G0 H60.0
		:G1 Y2.0F200 
    ...
    :M51
		...
		:G28H0
		:M23 S1000
		:G98 G0 X[#521+1.8]Z[#520+#523+1.7]Y0.525C0.0
		:G4 U0.05
    :G1 X4.0 F2000
		:G1 X3.25 F500
		:
