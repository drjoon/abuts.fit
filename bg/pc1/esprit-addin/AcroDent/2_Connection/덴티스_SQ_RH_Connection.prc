...
BEGIN_OPERATION; 316; CONNECTION; 0;
   ...
   Text; 513; ;  CAPTION; 문자; SOURCE; 2; TECHCODETYPE; 3;
    ...
    :(Deburr Step drill)
		...
		:G1 Z[#523-0.5] F0.1
		:G1 Z[#523+4.5] F0.04
		:G83 Z[#520+#523+4.2] Q1000 P5 F0.025
    :G80
		:G0 Z-1.5
    :G0 T0
    :M89
    ...
    :G99G0 X[#521+1.8] Z[#520+#523-0.256]
    :G1 X4.6 F0.1
    :G1 X4.0 F0.01
    :G3 X3.662 Z[#520+#523+0.02] R0.5
    :G1 X3.0 W1.704
		:G1 W0.84
		...
		:G28H0
		:M23 S5500
		:G0 X[#521+1.0] Y2.0 Z[#520+#523+2.46] C0.0
		:G98 G1X2.49 F3000
		:G1 Y-2.0 F200
		:G0 H60.0
		:G1 Y2.0F200 
    ...
    :M51
		...
		:G28H0
		:M23 S1000
		:G98 G0 X[#521+1.8]Z[#520+#523+2.0]Y0.4 C0.0
		:G4 U0.05
    :G1 X4.0 F2000
		:G1 X3.45 F500
		:
    ...
    :(Finish Connection)
    :M3 S3500 T0303(B-Turn/NR0.05)
    :G99 G0 X[#521+1.8]Z[#520+#523-0.278]
    :G1 X4.3 F0.1
    :G1 X3.9 F0.01
    :G3 X3.565 Z[#520+#523+0.01] R0.55
		:G1 X2.9 W1.709
		:G1 W0.845
