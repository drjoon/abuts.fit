...
BEGIN_OPERATION; 507; 5Axis_Composite; 0;
   ...
   ArcAngle; 3303; 20;  CAPTION; 원호 각도; SOURCE; 0; TECHCODETYPE; 2;
   ...
   ArcAngle; 3303; 20;  HIDDEN; CAPTION; 원호 각도; SOURCE; 0; TECHCODETYPE; 2;
   ...
   FirstPassPercent; 3462; 3;  CAPTION; 첫 패스 퍼센트; SOURCE; 2; TECHCODETYPE; 2;
   ...
   StepIncrement; 217; 0.08;  CAPTION; 스텝 간격; SOURCE; 2; TECHCODETYPE; 2;
   ...
   OperationName; 613; ;  CAPTION; 작업 이름; SOURCE; 2; TECHCODETYPE; 3;
	BEGIN_STRING; 613;;
		:5Axis_Composite
	END_STRING
   FullClearance; 443; 5;  CAPTION; 전체 여유; SOURCE; 2; TECHCODETYPE; 2;
   ...
   StartArcAngle; 3315; 15;  CAPTION; 시작 원호 각도; SOURCE; 0; TECHCODETYPE; 2;
   InRampLength; 3397; 0;  CAPTION; In 램프 거리|램프 거리 In, Out; SOURCE; 0; TECHCODETYPE; 2;
   OutArcAngle; 3402; 20;  CAPTION; Out 원호 각도|원호 각도 In, Out; SOURCE; 0; TECHCODETYPE; 2;
   ...
   MaximumLinkDistance; 3311; 3;  CAPTION; 최대 링크 거리; SOURCE; 0; TECHCODETYPE; 2;
   ...
   EndArcAngle; 3316; 15;  CAPTION; 원호 각도 끝; SOURCE; 0; TECHCODETYPE; 2;
   ...
   InArcAngle; 3403; 20;  CAPTION; In 원호 각도|원호 각도 In, Out; SOURCE; 0; TECHCODETYPE; 2;
   ...
   EndArcRadius; 3314; 0.5;  CAPTION; 원호 반경 끝; SOURCE; 0; TECHCODETYPE; 2;
   OutRampLength; 3396; 0;  CAPTION; Out 램프 길이|램프 길이 In, Out; SOURCE; 0; TECHCODETYPE; 2;
   MaximumLinkDistance; 3311; 5;  CAPTION; 최대 링크 거리; SOURCE; 0; TECHCODETYPE; 2;
   MaxZDifference; 3407; 10;  CAPTION; 최대 Z 차이; SOURCE; 0; TECHCODETYPE; 2;
   MinimumLoopWidth; 3404; 1;  CAPTION; 최소 루프 폭; SOURCE; 0; TECHCODETYPE; 2;
   InArcRadius; 3401; 2;  CAPTION; In 원호 반경|원호 반경 In, Out; SOURCE; 0; TECHCODETYPE; 2;
   EndArcAngle; 3316; 15;  CAPTION; 원호 각도 끝; SOURCE; 0; TECHCODETYPE; 2;
   ...
   MaximumLinkDistance; 3306; 5;  HIDDEN; CAPTION; 최대 링크 거리; SOURCE; 0; TECHCODETYPE; 2;
