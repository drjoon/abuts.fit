...
BEGIN_OPERATION; 553; Rough Mill 3D; 0;
   ...
   4904; 4904; ;  SOURCE; 0; TECHCODETYPE; 3;
	BEGIN_STRING; 4904;;
		:
	END_STRING
   OriginalKey; 4003; 4;  SOURCE; 0; TECHCODETYPE; 1;
   ...
   FeedratePT; 416; 0.025000000000000001;  CAPTION; 피드값 PT|피드값 PM, PT; SOURCE; 3; TECHCODETYPE; 2;
   ...
   ToolID; 498; ;  CAPTION; 공구 ID; SOURCE; 2; TECHCODETYPE; 3;
	BEGIN_STRING; 498;;
		:T06_BM_D4
	END_STRING
   IncrementalDepth; 175; 0.29999999999999999;  CAPTION; 증분 깊이; SOURCE; 2; TECHCODETYPE; 2;
   ...
   4430; 4430; 11;  SOURCE; 0; TECHCODETYPE; 2;
   ...
   FeedratePM; 191; 300;  CAPTION; 피드값 PM|피드값 PM, PT; SOURCE; 2; TECHCODETYPE; 2;
   ...
   4435; 4435; 99.00583184570398;  SOURCE; 0; TECHCODETYPE; 2;
   ...
   4908; 4908; ;  SOURCE; 0; TECHCODETYPE; 3;
	BEGIN_STRING; 4908;;
		:
	END_STRING
   MaxVertPlunge; 6676; 28.5;  HIDDEN; CAPTION; 최대 버트. 플런지; SOURCE; 1; TECHCODETYPE; 2;
   Rough5AxisStartPointY; 6659; 0;  HIDDEN; CAPTION; 축 시작 점 Z| 축 시작 점 X, Y, Z; SOURCE; 1; TECHCODETYPE; 2;
   ShankClearance; 3225; 0;  HIDDEN; CAPTION; 생크 공차; SOURCE; 1; TECHCODETYPE; 2;
   MaximumTiltAngle; 3412; 20;  HIDDEN; CAPTION; 최대 기울기 각도; SOURCE; 1; TECHCODETYPE; 2;
   StockAllowanceWalls; 233; 0.20000000000000001;  CAPTION; 벽면 가공 여유; SOURCE; 2; TECHCODETYPE; 2;
   ...
   PlungeFeedRatePercent; 3202; 25;  CAPTION; 플런지 피드값%; SOURCE; 2; TECHCODETYPE; 2;
