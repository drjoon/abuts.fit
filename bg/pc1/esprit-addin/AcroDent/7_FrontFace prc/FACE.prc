...
BEGIN_OPERATION; 552; EM2.0BALL; 0;
   ...
   StockAllowanceFloors; 272; -0.02;  CAPTION; 바닥 가공 여유; SOURCE; 2; TECHCODETYPE; 2;
   ...
   BottomZLimit; 1294; -0.2;  CAPTION; 바닥 Z 리미트; SOURCE; 2; TECHCODETYPE; 2;
   ...
   StepOver; 217; 0.15;  CAPTION; 스텝 오버|스텝 오버, 직경의 %값; SOURCE; 2; TECHCODETYPE; 2;
   ...
   StockAllowanceWalls; 233; -0.02;  CAPTION; 벽면 가공 여유; SOURCE; 2; TECHCODETYPE; 2;
