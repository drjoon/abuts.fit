...
BEGIN_OPERATION; 396; 솔리드턴-윤곽가공 [TURN_B]; 0;
   ...
   LengthCompRegister; 527; 5;  CAPTION; 길이 등록값; SOURCE; 1; TECHCODETYPE; 1;
   ...
   ZStock; 268; 0.3;  CAPTION; 소재 Z|소재 Z, X; SOURCE; 2; TECHCODETYPE; 2;
   FinishLeadInType; 1781; 11;  CAPTION; 리드-인 종류; SOURCE; 2; TECHCODETYPE; 339;
   EntryPointZ; 2920; -3;  LOCKED; CAPTION; 진입 점 Z|진입 점 Z, X; SOURCE; 2; TECHCODETYPE; 2;
   EntryMode; 693; 3;  CAPTION; 공구진입모드; SOURCE; 2; TECHCODETYPE; 341;
   ...
   EntryPointX; 2919; 9;  CAPTION; 진입 점 X|진입 점 Z, X; SOURCE; 2; TECHCODETYPE; 2;
