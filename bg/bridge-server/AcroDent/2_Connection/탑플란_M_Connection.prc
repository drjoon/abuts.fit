...
BEGIN_OPERATION; 316; CONNECTION; 0;
   ...
   Text; 513; ;  CAPTION; 문자; SOURCE; 2; TECHCODETYPE; 3;
	BEGIN_STRING; 513;;
		...
		:(BACKTURNING)  (TOPLAN M)
		:G97 M13  S2500
		:G0 Z[#520]
		:X18.
		:G99 G1 X6.0 F0.1
		:G1 X2.668 F0.01
		:G1 X2.34 Z[#520+0.845] F0.01
		:G1 Z[#520+3.05] F0.01
		:G1 X16.0 F0.1
		:G0 X40.0
		:G0 Z-5.0
		...
		:X16.0
                :G99 G1 X6.0 F0.1
		:G1 X2.668 F0.015
		:G1 X2.34 Z[#520+0.845] F0.015
		:G1 Z[#520+2.13] F0.01
		:G2 X1.9 Z[#520+2.35] R0.22 F0.008
		:G1 Z[#520+2.55] F0.008
		:G1 X16.0 F0.1
		:G0 X40.0
		:G0 Z-5.0
		:G0 T0
