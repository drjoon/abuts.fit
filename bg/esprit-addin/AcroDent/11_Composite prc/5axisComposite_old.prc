...
BEGIN_OPERATION; 507; 5Axis_Composite; 0;
   ...
   FirstPassPercent; 3462; 6.6732341766357433;  CAPTION; 첫 패스 퍼센트; SOURCE; 2; TECHCODETYPE; 2;
   ...
   4904; 4904; ;  SOURCE; 0; TECHCODETYPE; 3;
	BEGIN_STRING; 4904;;
		:
	END_STRING
   4003; 4003; 7;  SOURCE; 0; TECHCODETYPE; 1;
   ...
   FeedratePT; 416; 0.83333333333333337;  CAPTION; 피드값 PT|피드값 PM, PT; SOURCE; 3; TECHCODETYPE; 2;
   ...
   IncrementalDepth; 175; 0.375;  HIDDEN; CAPTION; 증분 깊이; SOURCE; 1; TECHCODETYPE; 2;
   ...
   StepIncrement; 217; 0.10000000000000001;  CAPTION; 스텝 간격; SOURCE; 2; TECHCODETYPE; 2;
   ...
   FeedratePM; 191; 10000;  CAPTION; 피드값 PM|피드값 PM, PT; SOURCE; 2; TECHCODETYPE; 2;
   ...
   OperationName; 613; ;  CAPTION; 작업 이름; SOURCE; 2; TECHCODETYPE; 3;
	BEGIN_STRING; 613;;
		:5Axis_Composite
	END_STRING
   FullClearance; 443; 20;  CAPTION; 전체 여유; SOURCE; 2; TECHCODETYPE; 2;
   ...
   4908; 4908; ;  SOURCE; 0; TECHCODETYPE; 3;
	BEGIN_STRING; 4908;;
		:
	END_STRING
   LastPassPercent; 3463; 53.5;  CAPTION; 마지막 패스 퍼센트; SOURCE; 2; TECHCODETYPE; 2;
   ...
   PlungeFeedRatePercent; 3202; 5;  CAPTION; 플런지 피드값%; SOURCE; 2; TECHCODETYPE; 2;
