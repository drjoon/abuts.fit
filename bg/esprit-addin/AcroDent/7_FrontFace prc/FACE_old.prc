...
BEGIN_OPERATION; 552; EM2.0BALL; 0;
   ...
   EntryMovesType; 3300; 4;  CAPTION; 접근 타입; SOURCE; 6; TECHCODETYPE; 431;
   ...
   4904; 4904; ;  SOURCE; 0; TECHCODETYPE; 3;
	BEGIN_STRING; 4904;;
		:
	END_STRING
   4003; 4003; 6;  SOURCE; 0; TECHCODETYPE; 1;
   ...
   BottomZLimit; 1294; -2.3346468353271486;  CAPTION; 바닥 Z 리미트; SOURCE; 2; TECHCODETYPE; 2;
   ...
   StepOver; 217; 0.050000000000000003;  CAPTION; 스텝 오버|스텝 오버, 직경의 %값; SOURCE; 2; TECHCODETYPE; 2;
   4430; 4430; 16;  SOURCE; 0; TECHCODETYPE; 2;
   ...
   FeedratePM; 191; 1000;  CAPTION; 피드값 PM|피드값 PM, PT; SOURCE; 3; TECHCODETYPE; 2;
   ...
   FullClearance; 443; 15;  CAPTION; 전체 여유; SOURCE; 2; TECHCODETYPE; 2;
   ...
   4435; 4435; 68.538046324401805;  SOURCE; 0; TECHCODETYPE; 2;
   ...
   StockAllowanceWalls; 233; 0.050000000000000003;  CAPTION; 벽면 가공 여유; SOURCE; 2; TECHCODETYPE; 2;
