...
BEGIN_OPERATION; 316; CONNECTION; 0;
   ...
   Text; 513; ;  CAPTION; 문자; SOURCE; 2; TECHCODETYPE; 3;
	BEGIN_STRING; 513;;
		...
		:(BACKTURNING)  (DENTIS R)
		:G97 M13  S2500
		:G0 Z[#520]
		:X18.
                :G99 G1 X6.0 F0.1
		:G1 X3.402 F.01
		:X2.81 Z[#520+1.524] F.01
		:Z[#520+3.7] F.01
		:X16.0 F0.1
		:G0 X40.0
		:G0 Z-5.0
		...
		:G99 G1 X6.0 F0.1
		:G1 X3.402 F0.015
		:G1 X2.81 Z[#520+1.524] F0.015
		:G1 Z[#520+2.383] F0.01
		:G2 X2.595 Z[#520+2.511] R0.13 F0.008
		:G1 X2.42 Z[#520+2.526] F0.008
		:G1 X2.384 Z[#520+2.619] F0.008
		:G2 X2.188 Z[#520+2.7] R0.1 F0.008
		:G1 Z[#520+2.9] F0.008
		:G1 X16.0 F0.05
		:G0 X40.0
		:G0 Z-5.0
