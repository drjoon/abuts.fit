...
BEGIN_OPERATION; 316; [10.0MM_기준]DIO_Connection; 0;
   ...
   Text; 513; ;  CAPTION; 문자; SOURCE; 2; TECHCODETYPE; 3;
	BEGIN_STRING; 513;;
		...
		:G99 G1 X6.0 F0.1
		:G1 X3.401 F0.015
		:G1 X2.8 Z[#520+1.545] F0.015
		:G1 Z[#520+2.286] F0.01
		:G2 X2.552 Z[#520+2.434] R0.15 F0.008
		:G1 X2.451 Z[#520+2.443] F0.008
		:G1 X2.258 Z[#520+2.939] F0.008
		:G2 X2.111 Z[#520+3.0] R0.075 F0.008
		:G1 Z[#520+3.2] F0.008
		:G1 X16.0 F0.1
		:G0 X40.0
		:G0 Z-5.0
