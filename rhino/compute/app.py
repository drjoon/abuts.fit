...
STORE_ROOT = APP_ROOT.parent / "Stl-Stores"
STORE_IN_DIR = STORE_ROOT / "in"
STORE_OUT_DIR = STORE_ROOT / "out"
...
def on_startup() -> None:
    _ensure_dirs()
    # Rhino/pipeId 풀 초기화는 startup에서 수행하지 않는다.
    # (NEW DOCUMENT 실행 등이 startup을 블로킹할 수 있어 서버가 뜨지 않는 문제 방지)
